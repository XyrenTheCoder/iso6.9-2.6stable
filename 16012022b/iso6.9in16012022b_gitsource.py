...
async def embed(ctx):
    embed=discord.Embed(title="**help command list of iso6.9**", description="version: 16012022b\ncurrent prefix: `]`", color=discord.Color.blue())
    ...
    embed.add_field(name='misc:', value="snipe (channel), edit_snipe (global), 8ball, fstab, roll, say, null, sus, notify, stroke, randnum, kill, amogus, guess, duel, cup, lick, spam, encode, decode, stroktranslate", inline=False)
...
async def embed77(ctx):
    ...
    embed.add_field(name='misc:', value="snipe (channel), edit_snipe (global), 8ball, fstab, roll, say, null, sus, notify, stroke, randgen, kill, amogus, guess, duel, cup, lick, spam, enc, dec, stroktrans", inline=False)
...
#            print(f"[log] {ctx.author} returned an error: No results found.")  
